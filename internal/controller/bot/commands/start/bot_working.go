...
func NewStartBotCommand(logger *slog.Logger, bot telegram.Bot, tgUser tg.TgUserDTO, userService bot_interfaces.UserService, messageService bot_interfaces.MessageService, botService bot_interfaces.BotService) StartBotCommand {
