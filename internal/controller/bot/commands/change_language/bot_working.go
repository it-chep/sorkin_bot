...
func NewChangeLanguageCommand(logger *slog.Logger, bot telegram.Bot, tgUser tg.TgUserDTO, userService bot.UserService, messageService bot.MessageService, botService bot.BotService) ChangeLanguageCommand {
